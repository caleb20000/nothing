...
namespace Com.Itrus.Crypto
{
    public class SM2
    {
        ...
        public  ECCurve ecc_curve;//椭圆曲线的产生字段
        public  ECPoint ecc_point_g;//g点坐标的字段
        ...
        public virtual byte[] Sm2GetZ(byte[] userId, ECPoint userKey)
        {
           ...
           // userId = System.Text.Encoding.GetEncoding("ISO-8859-1").GetBytes("1234567812345678");
